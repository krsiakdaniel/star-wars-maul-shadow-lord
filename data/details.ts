import { type CastMember, type ShowDetail } from '@/features/SectionDetails/Details.types'
...
export const SHOW_DETAILS: ShowDetail[] = [
  { key: 'Created by', value: 'Dave Filoni' },
  { key: 'Director', value: 'Brad Rau' },
  { key: 'Head Writer', value: 'Matt Michnovetz' },
  { key: 'Network', value: 'Disney+' },
  { key: 'Genre', value: 'Animated · Sci-Fi · Action' },
  { key: 'Premiered', value: 'April 6, 2026' },
  { key: 'Tomatometer', value: '100%' },
  { key: 'Metacritic', value: '75 / 100' },
  { key: 'Episodes', value: '10' },
]
